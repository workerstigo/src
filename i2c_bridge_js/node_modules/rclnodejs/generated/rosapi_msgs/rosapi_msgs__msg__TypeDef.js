...
class TypeDefWrapper {
  ...
  freeze(own) {
    ...
    this._wrapperFields.fieldnames.freeze(own);
    ...
    this._wrapperFields.fieldtypes.freeze(own);
    ...
    this._wrapperFields.fieldarraylen.freeze(own);
    ...
    this._wrapperFields.examples.freeze(own);
    ...
    this._wrapperFields.constnames.freeze(own);
    ...
    this._wrapperFields.constvalues.freeze(own);
